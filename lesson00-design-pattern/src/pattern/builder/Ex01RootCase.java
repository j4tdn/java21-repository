...
public class Ex01RootCase {
	...
	public static void main(String[] args) {
		...
		/*	 
		  Design Pattern: Là các mẫu thiết kế, được sinh ra/tạo ra từ kinh nghiệm của các người đi trước 
		  ...
		  + Đặt vấn đề
		    ...
		    --> Vì constructor luôn trùng tên với class
		        Ví dụ: cần constructor 2 tham số a1, a2, và cần 1 constructor a5, a6
