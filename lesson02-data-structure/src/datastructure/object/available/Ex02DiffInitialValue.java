...
public class Ex02DiffInitialValue {
	public static void main(String[] args) {
		...
		//Khởi tạo không dùng từ khóa new -- giá trị sẽ lưu trữ ở vùng nhớ HEAP/constand pôl
		//Kiểm tra xem giá trị chuẩn bị khởi tạo đã tồn tại trên constant pool chưa
		// + Nếu chưa tồn tại thì tọa ô nhớ mới và gán địa chỉ về cho biến (stack)
		...
		System.out.println("s01 (" + so1 +") --> address (" +System.identityHashCode(so1)+ ")");
		System.out.println("s02 (" + so2 +") --> address (" +System.identityHashCode(so2)+ ")");
		System.out.println("\n=======================\n");
		String  s3 = "hila";
		String  s4 = "hila";
		String  s5 = "hila";
		String  s6 = "hila";	// 100 biến stack đang trỏ cùng đến cùng giá trị hila
		System.out.println("\n=======================\n"); 
		s4 = "lalala";
