	...
	public static void main(String[] args) {
		...
		/* khai báo và khởi tạo giá trị cho biến thuộc KDL đối tượng
		   ...
		   --> default constructor
		   	   ...
		   	   + có đầy đủ thông tin tất cả các thuộc tính của class chưas nó
		...
		// Java có class gọi là cha của tất cả các KDL của đối tượng(class) --> Object
		...
		// thực tế cần:
		// khi in ra biến KDL đối tượng --> in ra giá trị tất cả các thuộc tính của ô nhớ mà biến đó đang trỏ đến
