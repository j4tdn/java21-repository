...
public class Ex01IoBasicDemo {
	...
	public static void main(String[] args) {
		...
		// string: 
		// không nhập gì --> mà nhấn enter --> lưu chuỗi rỗng vào biến
		// nhập --> nhấn enter --> lưu giá trị vừa nhập vào biến
		
		// !string(int, double, float)
		// không nhập gì --> nhấn enter --> không thực hiện thao tác, phải đợi cho đến khi nhập gì đó thì enter mới hiệu nghiệm
		// nhập --> nhấn enter --> lưu giá trị vừa nhập vào biến
