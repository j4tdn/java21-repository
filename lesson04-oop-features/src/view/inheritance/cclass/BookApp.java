...
public class BookApp {
	...
	public static void main(String[] args) {
		/*
		 * Cho ứng dụng quản lý thông tin sách 
		 * Thông tin sách: 
		 ...
		 * 
		 * KDL == enum() --> khi muốn lưu trữ tập hợp các giá trị là hằng số, bất biến(imutable) 
		 * 				 --> KDL đối tượng --> Lưu trữ tập hợp các đối tượng là imutable bên trong nó 
		 * 				 --> default empty constructor --> private(unmodifiable) 
		 * 					 kh thể đổi private thành public
		 
		 * Tạo ds N cuốn sách(mảng) --> Thực hiện việc mua k/n cuốn sách và tính tổng
		 * tiền phải chi trả
		 */
