...
public class Ex01TransactionApp {
	public static void main(String[] args) {
		...
		Set<List<Transaction>> set = new LinkedHashSet<>();
		set.add(transactions);
		printf(set);
	...
	private static void printf(Set<List<Transaction>> transactions2) {
		transactions2.forEach((items) -> {
			System.out.println("1. All transactions in the year 2011:");
			for (var item: items) {
				if(item.getYear() == 2011) {
