...
public static String getStringUpperCase(String msg, boolean isEmpty) {
	String s = "";
	...
	do
	{
		...
		try {
			...
			if(isEmpty)
                loop = false;
            else if(!s.isEmpty() && isValidString(s)) {
                loop = false;
...
private static final String STRING_NAME_PATTERN = "[A-Z]+";
