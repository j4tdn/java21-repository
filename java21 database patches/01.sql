...
CREATE TABLE T02_ITEM_GROUP(
    ...
    CONSTRAINT UNQ_ITEMGROUP_NAME UNIQUE (C02_ITEM_GROUP_NAME)
);
...
CREATE TABLE T01_ITEM(
    ...
    -- vì nó luôn lấy name = PRIMARY_KEY
    ...
    -- ở bảng con --> báo lỗi
    CONSTRAINT FK_ITEM_ITEMGROUP FOREIGN KEY (C01_ITEM_GROUP_ID)
...
CREATE TABLE T06_SIZE(
    ...
    -- TINYINT(1) --> chỉ nhận 0 -> 9  --> tối đa 1 kí tự
...
CREATE TABLE T12_ITEM_DETAIL(
	...
	CONSTRAINT UNQ_ITEM_SIZE_NAME UNIQUE (C12_ITEM_ID, C12_SIZE_ID, C12_COLOR),
