...
public class JdbcItemDao extends GenericDao implements ItemDao{
	...
	private static final String GET_ITEMS_BY_SALES_DATE = ""
			...
			+ "	SELECT DISTINCT t12.C12_ITEM_DETAIL_ID ITEM_ID\n"
	...
	public List<Item> getAll() {
		return getElements(GET_ALL_ITEMS, ItemTransformer::transformItemWithGroup);
	}
	
	@Override
	public List<Item> getItemsBySaleDate(LocalDate salesDate) {
		return getElements(GET_ITEMS_BY_SALES_DATE, ItemTransformer::transformItem, 
				(pst) -> {
					try {
