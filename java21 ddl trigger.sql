...
-- VD: Tạo 1 trigger cho TABLE T1 có nhiệm vụ tracking lưu lại thông tin của các dòng dữ liệu
-- đã bị xóa gồm: user, data_row, thời gian			
...
-- DROP TRIGGER delete_item_groups_trigger
DELIMITER $$
CREATE TRIGGER delete_item_groups_trigger
