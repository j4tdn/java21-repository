...
public class Ex06TimeDuration {
	...
	/*
	 Hạn chế của Date Time trước java1.8
	 
	 + Date, Calendar luôn lưu trữ dMy Hms
	   --> ko hỗ trợ riêng lẽ
	   --> khó khăn khi lưu trữ cũng như chuyển đổi qua về với fate(dMy) time(Hms) trong dâtbase
	 + Ít hỗ trựo hàm tìm hiễu giữ 2 mốc thời gian
	 */
}
