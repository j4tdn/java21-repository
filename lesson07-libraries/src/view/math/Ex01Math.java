...
public class Ex01Math {
	...
	public static void main(String[] args) {
		...
		// BigDecimal bdValue = bd(17).divide(bd(7)); // Non-terminating decimal
		...
		// Số --> Làm tròn --> Kết quả vẫn là số --> dùng số để tính toán -->
		// BigDecimal, Math

		// Số --> Định dạng --> Trả về String hiển thị ra console với những format khác
		// nhau , . - --> NumberFormat, DecimalFormat
	}
}
