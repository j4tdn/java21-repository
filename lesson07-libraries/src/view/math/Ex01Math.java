...
public class Ex01Math {
	...
	public static void main(String[] args) {
		...
		System.out.println("bigdecimal test02 --> " + new BigDecimal(String.valueOf(test))); // giữ nguyên giá trị khi đưa qua BigDecimal
		...
		float val = 10f/3; // 3.3333333 --> mặc định 7 chữ số, yêu cầu làm tròn 10 chữ số khi chia số thực
