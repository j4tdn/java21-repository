...
-- T03_ORDER, T04_PAYMENT_METHOD, T05_ORDER_STATUS, T11_CUSTOMER, T14_ORDER_DETAIL, T15_ORDER_STATUS_DETAIL, T07_EMPLOYEE
-- Thiếu bảng ??? BILL ???
...
-- Thông thường(thực tế) thì nên dùng 1 trong 2 cách dưới để generate ID
-- INT PRIMARY KEY
...
CREATE TABLE T03_ORDER (
    ...
    CONSTRAINT CHECK_C03_TOTAL_OF_MONEY_POSITIVE CHECK (C03_TOTAL_OF_MONEY >= 0),
...
CREATE TABLE T15_ORDER_STATUS_DETAIL (
    ...
    C15_LAST_UPDATE DATETIME NOT NULL DEFAULT current_timestamp(),
