...
public class App {
	...
	public static void main(String[] args) {
		...
		Customer c2 = new Customer("KH2", "Kate", "243", "Calyfornia");
		...
		Order o3 = new Order(c2, new ItemDetail[] {
				new ItemDetail(i4, 1),
 		}, LocalDateTime.of(2021, 5, 8,9,22,32));
		
		/*
		 * c1: KH1, Adam, 123, NewYork
		 * c2: KH2, Kate, 243, Calyfornia
		 ...
		 * 
		 * o1: c1, {id1(i1,3),id2(i4,1), id3(i2,1)}, 10:10:1008.05.2021
		 * o2: c2, {id1(i3,2), id2(i5,1)}, 20:10:12 07.05.2021
		 * o3: c3, {id1(i4,1), 09:28:32 08.05.2021
		 */
		
		// viết meothd export in Order class
