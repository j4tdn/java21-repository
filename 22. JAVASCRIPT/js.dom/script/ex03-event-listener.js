...
clickMe.onclick = function() {
	console.log('onclick: test 01');
}

clickMe.onclick = function() {
	console.log('onclick: test 02');
}

clickMe.addEventListener('click', function() {
	console.log('addEventListener(click): test 01');
})

clickMe.addEventListener('click', function() {
	console.log('addEventListener(click): test 02');
})

// Yêu cầu 1: Khi nhấn vào button bên trong container
// --> đổi màu button đó, sử dùng màu random
