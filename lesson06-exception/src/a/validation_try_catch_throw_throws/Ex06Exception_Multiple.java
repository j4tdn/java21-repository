...
public class Ex06Exception_Multiple {
	...
	/*
	 ...
	 --> xoá luôn exception con, catch duy nhất exception cha
	 
	 * Không nên catch duy nhất Exception cho mọi trường hợp
	 * --> Code ko rõ ràng, không biết code đạng bị exception gì
	 
	 */
	public static void main(String[] args) {
		try {
			System.out.println("Calculate value: " + manualInputAndDivide());
