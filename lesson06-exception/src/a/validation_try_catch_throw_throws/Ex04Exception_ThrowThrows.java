...
public class Ex04Exception_ThrowThrows {
	...
	//      : ném khi mà exception xảy ra hay ko phụ thuộc vào parameter truyền vào 
	//      : lúc gọi hàm
	// throws: ném compile exception ở chỗ khai báo hàm để nơi gọi hàm này phải 
	//       : xử lí lỗi

	// compile, runtime exception
	// trong hàm: nếu mình throws new runtime exception(RE) 
	...
	// trong hàm: nếu mình throws new compile exception(CE) 
