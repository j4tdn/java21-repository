...
public class Ex04Exception_ThrowThrows {
	...
	//		: ném khi mà exception xảy ra hay không phụ thuộc vào param truyền vào
	//		  lúc gọi hàm
	...
	//				thì tại chỗ khai báo hàm ko bắt buộc phải throws ra CE
	...
	// path = [folder]../..filename.ext(txt, ipg, pdf)
