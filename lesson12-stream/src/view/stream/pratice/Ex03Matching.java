...
public class Ex03Matching {
	...
	public static void main(String[] args) {
		...
		//expample: Give a list of number: 1 , 2, 1 ,4 ,5 , 8, 10, 4, 12
		...
		System.out.println("st: is there any element that is divisible by 10: " +r1);
		
		//2nd: find the first element that is divisible by 4
		
		//optional --> Hạn chế NPE exception
		//T: null, non null
		//Optional --> luôn khác null, trước khi lấy T hỗ trợ ấc hàm kiểm tra như isPresent,ifPresent
		//T
