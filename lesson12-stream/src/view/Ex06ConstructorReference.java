...
public class Ex06ConstructorReference {
	...
	private static <T extends Map<Integer, String>> Map<Integer, String> sort(Map<Integer, String> map, Comparator<Entry<Integer, String>> comparator, Supplier<T> supplier) {
