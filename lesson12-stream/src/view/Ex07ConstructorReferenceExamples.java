...
public class Ex07ConstructorReferenceExamples {
	...
	public static void main(String[] args) {
		...
		// dang4 constructor reference cho hàm khởi tạo có 4 tham số
		BuFunction<Integer, String, LocalDate, BigDecimal, TestCon> buf = (a1, a2, a3, a4) -> new TestCon(a1, a2, a3, a4);
		//System.out.println("buf1 --> " + buf.apply(null, null, null, null));
		...
		buf = TestCon::new;
		System.out.println("buf2 --> " + buf.apply(1, "bo", LocalDate.now(), BigDecimal.TEN));
		...
		// muốn biết bên phải gọi đến chính các code, hàm nào --> dựa vào thằng bên trái
	...
	static class TestCon{
		...
		public static TestCon tranfer(String line) {
			String[] tokens = line.split(", ");
