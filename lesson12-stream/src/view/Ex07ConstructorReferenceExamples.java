...
public class Ex07ConstructorReferenceExamples {
	...
	public static void main(String[] args) {
		...
		BuFunction<Integer, String, LocalDate, BigDecimal, TestCon> buf = (a1, a2, a3, a4) -> new TestCon(a1, a2, a3,
				a4);
		System.out.println("buf1 --> " + buf.apply(11, "vu", LocalDate.now(), BigDecimal.valueOf(229)));
		...
		buf = TestCon::new;
		System.out.println("buf2 --> " + buf.apply(11, "vu", LocalDate.now(), BigDecimal.valueOf(229)));
