...
public class Ex01ArrayDeclaration {
	...
	public static void main(String[] args) {
		// mảng chứa các phần tử là KDL  nguyên thuỷ, KDL đối tượng

		
		// khai báo mảng 1 chiều
		int[] digits = new int[3];
		int[] numbers = new int[] {2,5,8};
		int[] elements = {2,5,8,10};
		...
		// mảng 1 chiều: mỗi phần tử là 1 giá trị đơn(nguyên thuỷ, đối tượng)
		...
		// maxtrix.length: số phần tử của mảng --> số dòng
		...
		// Type[] types = {new Type(1,2,3), new Type(5,6,7)};
		// Type: x,y,z
