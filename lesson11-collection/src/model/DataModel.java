...
public class DataModel {
	...
	public static List<Item> mockItem() {
		...
		items.add(new Item(22, "CItem", bd("66"), 2, dt("22/08/2023 17:12:22")));
		items.add(new Item(21, "KItem 21", bd("18"), 2, dt("05/05/2023 18:12:22")));
		items.add(new Item(12, "Item", bd("99"), 1, dt("24/12/2023 12:12:22")));
		items.add(new Item(11, "Item 55", bd("55"), 5, dt("16/11/2023 15:12:22")));
	...
	public static Item[] mockItem_NullValues() {
		return new Item[]  { 
				...
				null,
				new Item(22, "CItem", bd("66"), 2, dt("22/08/2023 17:12:22")),
				new Item(21, "KItem 21", bd("18"), 2, dt("05/05/2023 18:12:22")),
				new Item(12, "Item", bd("99"), 1, dt("24/12/2023 12:12:22")),
				null,
