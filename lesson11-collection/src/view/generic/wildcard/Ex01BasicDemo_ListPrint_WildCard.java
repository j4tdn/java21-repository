...
public class Ex01BasicDemo_ListPrint_WildCard {
	...
	public static <E extends Number> void printList_UsingGenericType(List<E> es) {
		for (E e: es) {
			// item.get...
			System.out.print(e + " ");
		}
	...
	public static void printList_UsingGenericWildCard(List<? super String> es) {
		for (Object e: es) {
			// convert item ...
			System.out.print(e + " ");
		}
	...
	public static void addAll_GWildCard(List<?> list1, List<?> list2) {
		// list1.addAll(list2);
		// lỗi compile do k xác định được KDL của list2 có giống hoặc con của KDL của list1
	}
