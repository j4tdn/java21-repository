...
public class Ex03MapIdeaOfOverLappingKeys {
	...
	public static void main(String[] args) {
		// map gồm tập các phần tử --> hỗ trợ tìm kiếm các mặt hàng đc bán trong cửa hàng nhanh hơn
		// k -> store
		...
		// kiểm tra
		// 1. hashcode của key trùng với hashcode của keys nào bên map chưa
		...
		// hashcode --> mặc định = System.identityHashCode(object) --> địa chỉ ở HEAP của đối tượng
		// equals --> mặc định so sánh địa chỉ của 2 đối tượng dùng toán tử ==
