...
public class Ex03MapIdeaOfOverlappingKeys {
	...
	// map gồm 1 tập các phần tử -> hỗ trợ tìm kiếm các mặt hàng được bán trong cửa hàng nhanh hơn
	// k - store
	// v - items mà store đó đang bán	
	// store 1 --> item 11, item 12
	// store 2 --> item 21, item 22
	// store 3 --> item 31, item 32, item 33
	// store 4 --> item 41
	...
	storeItemsMap.put(	
	 ...
	 storeItemsMap.put(
			 ...
			 List.of(new Item(31, "Item 31",bd(31), 3, LocalDateTime.now()),
	                 ...
	                 new Item(34, "Item 32",bd(34), 3, LocalDateTime.now())));
	 storeItemsMap.put(
			 new Store(4, "Store 4"),
	...
	// -----------------------
	 ...
	 // 2. key có euqals với keys nào trong map chưa
	 ...
	 // phải bổ sung hàm ghi đè hashCode, equals
	 
	 //hashcode --> công thức để hashing giá trị của thuộc tính --> trả về int (dãy số)
	 
	 //	sau khi override --> 2 đối tượng mà euqals thì phải có hashcode giống nhau
	 
	 
	 storeItemsMap.put(
			 new Store(3, "Store 3"),
			 List.of(new Item(91, "Item 91",bd(31), 3, LocalDateTime.now()),
	                 new Item(92, "Item 92",bd(34), 3, LocalDateTime.now())));
