...
public class Ex02GenericMethod_ListParam {
	...
	public static void main(String[] args) {
		...
		List<Object> objects = List.of("a", 1, 2d, 22L);

		// generateObjects("1. Ints", ints); --> Lỗi
		...
		//generate("4. Strings", strings); --> lỗi vì ko phải con của Number
		//generate("5. Objects", objects);

	}

	// List<Object> --> KDL List --> tham số truyền vào kiểu List
	// List<Integer> --> KDL List --> tham số truyền vào kiểu Integer
	// --> đều là KDL List với tham số truyền vào khác nhau
