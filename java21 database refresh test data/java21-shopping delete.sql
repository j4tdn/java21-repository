...
-- Phân biệt DELETE, DELETE FROM, DROP
-- Nên dùng DELETE hay DELETE FROM để xóa dữ liệu

-- DELETE FROM: drop and recreate table without data (DML, DDL tùy hệ quản trị)
